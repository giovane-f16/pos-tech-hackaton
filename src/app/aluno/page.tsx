    ...
    return (
        <main className="container mx-auto px-4 py-8">
            ...
            <section className="mt-8">
                ...
                {tab == "assistant" && (
                    <div className="border-gray-200 border rounded-lg p-6">
                        <h2 className="text-[18px] font-semibold mb-1.5">Assistente de IA</h2>
                        <p>Converse com a IA para obter ajuda com seus trabalhos</p>
                        <div className="mt-6 border border-gray-300 rounded-md p-4 h-96 overflow-y-auto bg-gray-50">
                            <p className="text-gray-500">Área de chat com a IA (em desenvolvimento)</p>
                        </div>
                        <form className="mt-4 flex gap-2">
                            <input type="text" placeholder="Digite sua pergunta..." className="border border-gray-300 rounded-md p-2 w-full border-input bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300" />
                            <button type="submit" className="bg-black text-white rounded-lg px-4 py-1.0 hover:bg-gray-800 cursor-pointer flex items-center justify-center gap-2">
                                <Send size={18} />
                            </button>
                        </form>
                    </div>
