    ...
    <main className="flex bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-black">
        ...
        <div className="text-center mb-16">
          <h1 className="mb-4 flex items-center justify-center gap-2">
            ...
            <span className="text-4xl font-bold">EduPlataforma</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white text-card-foreground flex flex-col gap-6 rounded-xl border border-gray-200">
                <div className="@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-6 pt-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6">
                    <h4 className="flex items-center gap-2 leading-none">
        ...
        <div className="text-center">
          <h2 className="mb-4 font-bold">Pronto para começar?</h2>
          <p className="text-gray-600 mb-8 text-lg">
            Crie sua conta e comece a usar a plataforma hoje mesmo
          </p>
          <a href="/auth">
            <button className="text-lg px-8 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition cursor-pointer">
